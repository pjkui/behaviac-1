...
#ifndef BEHAVIAC_GENERATED_BEHAVIORS_H
#define BEHAVIAC_GENERATED_BEHAVIORS_H
...
namespace behaviac
{
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			pAgent->SetVariable("enemyType", 257823859u, opr);
			return result;
		}
	};
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			pAgent->SetVariable("initSpeed", 1002713030u, (opr)[opr_index]);
			return result;
		}
	};
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			pAgent->SetVariable("randomSpeed", 1466300189u, opr);
			return result;
		}
	};
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			BEHAVIAC_ASSERT(behaviac::MakeVariableId("enemyType") == 257823859u);
			pAgent->SetVariable("enemyType", 257823859u, opr2);
			return result;
		}
	};
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			BEHAVIAC_ASSERT(behaviac::MakeVariableId("initSpeed") == 1002713030u);
			pAgent->SetVariable("initSpeed", 1002713030u, opr2);
			return result;
		}
	};
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			BEHAVIAC_ASSERT(behaviac::MakeVariableId("randomSpeed") == 1466300189u);
			pAgent->SetVariable("randomSpeed", 1466300189u, opr2);
			return result;
		}
	};
...
#endif // BEHAVIAC_GENERATED_BEHAVIORS_H
